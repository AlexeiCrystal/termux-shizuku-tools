...
[![Build package on push](https://github.com/AlexeiCrystal/termux-shizuku-tools/actions/workflows/build-den-on-push.yml/badge.svg)](https://github.com/AlexeiCrystal/termux-shizuku-tools/actions/workflows/build-den-on-push.yml)
...
2. Пролистайте вниз и скопируйте команды для установки
...
<a href="https://www.star-history.com/?repos=AlexeiCrystal%2Ftermux-shizuku-tools&type=date&legend=top-left">
 <picture>
   ...
   <img alt="График истории звёзд" src="https://api.star-history.com/chart?repos=AlexeiCrystal/termux-shizuku-tools&type=date&legend=top-left" />
 </picture>
</a>